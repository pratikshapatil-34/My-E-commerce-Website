      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-indigo-400">ModernShop</h3>
            <p className="text-gray-300 leading-relaxed">
              Your trusted destination for premium products that combine quality, 
              style, and innovation. Elevating lifestyles since 2019.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">hello@modernshop.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 Fashion St, NY 10001</span>
              </div>
            </div>
          </div>
        </div>
